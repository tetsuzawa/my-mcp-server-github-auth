...
declare namespace Cloudflare {
	...
	interface Env {
		...
		AI: Ai;
        // --- Custom project bindings (added manually) ---
...
// Augmented Env interface to include project-specific environment variables.
// If this file gets regenerated by Wrangler, extract this block into a separate
// `src/env.d.ts` (and include it via tsconfig "include") to persist custom fields.
interface Env extends Cloudflare.Env {
    AUTH0_CLIENT_ID: string;
    AUTH0_CLIENT_SECRET: string;
    AUTH0_ISSUER: string; // e.g. https://<tenant>.auth0.com
    AUTH0_AUDIENCE: string;
    COOKIE_ENCRYPTION_KEY: string;
}
